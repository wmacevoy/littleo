...
\multicolumn{1}{c}{$h$} & 
\multicolumn{1}{c}{$\begin{array}{r}(1+h)^{1/h}\\-e\\\hline E\end{array}$} &
\multicolumn{1}{c}{$\varepsilon(h)=h^1$} &
\multicolumn{1}{c}{$r=\left|\frac{E}{\varepsilon(h)}\right| $} \\
\hline
0.01 & $\begin{array}{lr}&2.7048\\-2.7183\\\hline\\-0.0135\end{array}$   & 1 & 0.0135 \\
\hline
\end{tabular}
\end{table}
%-0.0001 & 2.718417755 & 2.7182818...  0.000136  1  0.000136 
%0.00001 & 2.718280469 & 2.7182818...  -0.00000136  1  0.00000136 
